...
# SVC-C2-016 has no interrupt() (hitl.enabled false) → auto-skips. A HITL template replaces this
# with a real GraphInterrupt-propagation test (per the framework's PB-7 Proof-of-Boundary spec).
import os
import re
